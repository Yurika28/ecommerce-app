...
const Slides =[
        <div key="slide-decor" className="w-full h-full p-2 gap-2 flex items-center justify-between bg-neutral-200 dark:bg-neutral-700 rounded-[1rem]">
        ...
        <div key="slide-skincare" className="relative w-full h-full p-2 flex items-center justify-between bg-rose-100 dark:bg-rose-900 rounded-[1rem]">
            <div className="flex flex-col justify-center gap-2 md:justify-around items-start h-full">
        ...
        <div key="slide-makeup" className="relative w-full h-full p-4 flex items-center justify-between bg-pink-100 dark:bg-pink-900">
        ...
        <div key="slide-groceries" className="relative w-full h-full p-2 flex items-center justify-between bg-green-100 dark:bg-green-900 rounded-[1rem]">
        ...
        <div key="slide-clothing" className="relative w-full h-full p-2 gap-2 flex items-center justify-between bg-indigo-100 dark:bg-indigo-900">
            <div className="flex flex-col justify-center gap-2 md:justify-around items-start h-full">
        ...
        <div key="slide-footwear" className="relative w-full h-full p-2 gap-2 flex items-center justify-between bg-gray-100 dark:bg-gray-700">
