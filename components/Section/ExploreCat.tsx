  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto px-4 py-6">
      <div className="grid grid-cols-5 grid-rows-4 gap-2 min-h-[320px] md:min-h-[50vh] md:gap-6">
        ...
        <div className="flex items-end justify-center col-start-5 col-end-6 row-start-1 row-end-5 p-4 rounded-lg shadow bg-[#eac2be] bg-[url('https://cdn.dummyjson.com/product-images/beauty/red-lipstick/thumbnail.webp')] bg-contain md:bg-auto bg-center">
